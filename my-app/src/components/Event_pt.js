...
function Event_pt(){
    ...
    const urlEvent = `http://localhost:5000/api/v1/event/${eventId}`;
    const urlParticipants = `http://localhost:5000/api/v1/event/${eventId}/participants`;
